...
\033[1;92m☞ WhatsApp   : 03023095528
\033[1;95m☞ Facebook_Id    : https://m.facebook.com/burhanali00
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('https://m.facebook.com/burhanali00')
		    menu()
		else:
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Burhan_ALi')
	    os.system('cd $HOME && git clone https://github.com/burhanali007/Burhan_Ali.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03023095528✓')
	    psb('WellCome To BURHAN_ALi')
	    psb('Congratulations BURHAN_ALi Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Burhan✓')
	    psb('🔓Password ☆ Ali✓')
	    psb('My Facebook_Id https://m.facebook.com/burhanali00✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/BURHAN_ALi && python2 Burhan.py')
	elif bm =='3':
